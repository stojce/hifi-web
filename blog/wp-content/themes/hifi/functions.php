...
function get_random_posts($posts_number = 2) {
    $args = array( 'numberposts' => $posts_number, 'orderby' => 'rand' );
...
function bones_comments($comment, $args, $depth) {
    ...
    <article id="comment-<?php comment_ID(); ?>" class="clearfix article-comment">
        <div class="comment-text">
            <h4>
                <span class="comment-author"><?php echo get_comment_author_link(); ?></span>
                on <?php comment_time('F j, Y'); ?>
            </h4>
            <?php edit_comment_link('Edit', '<span class="edit-comment btn btn-small btn-info"><i class="icon-white icon-pencil"></i>','</span>') ?>
...
function theme_styles()
{
    ...
    wp_register_style( 'font-awesome', get_template_directory_uri() . '/library/css/font-awesome.min.css', array(), '3.0.3', 'all' );
...
function theme_js(){
    ...
    wp_register_script('jquery', get_template_directory_uri().'/library/js/libs/jquery-1.9.0.min.js', false, '1.9.0');
    ...
    wp_register_script('typekit', '//use.typekit.net/xyu1mnf.js');
    wp_enqueue_script('typekit');

    wp_register_script('jquery.syntax', get_template_directory_uri() . '/library/js/jquery.syntax/jquery.syntax.js');
    wp_enqueue_script('jquery.syntax');

    wp_register_script('jquery.syntax.cache', get_template_directory_uri() . '/library/js/jquery.syntax/jquery.syntax.cache.js');
    wp_enqueue_script('jquery.syntax.cache');
}
