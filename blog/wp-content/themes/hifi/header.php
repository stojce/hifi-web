...
<!--[if (gte IE 9)|(gt IEMobile 7)|!(IEMobile)|!(IE)]><!--><html <?php language_attributes(); ?> class="no-js"><!--<![endif]-->
	...
	<head>
        ...
        <script>try{Typekit.load();}catch(e){}$(function(){$.syntax();})</script>
        ...
        <link rel="stylesheet" type="text/css" href="<?php echo WP_NAVBAR_CSS ?>" />
        <link rel="stylesheet" type="text/css" href="<?php echo WP_FOOTER_CSS ?>" />
	</head>

	<body <?php body_class(); ?>>
        <?php require(WP_NAVBAR_VIEW); ?>
